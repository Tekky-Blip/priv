...
if localVersion ~= version then
    OrionLib:MakeNotification({Name = "Script version mismatch!", Content = "You seem to have an older version of Lirux. Original Loadstring has been copied", Image = "rbxassetid://4483345998", Time = 8})
...
local Window = OrionLib:MakeWindow({
    Name = "Lirux - Latest: " .. version, 
    HidePremium = false, 
    SaveConfig = true, 
    ConfigFolder = "Lirux HUB", 
    IntroEnabled = true, 
    IntroText = "Lirux" ..version, 
...
OrionLib:MakeNotification({Name = "Welcome", Content = "Welcome to Lirux", Image = "rbxassetid://4483345998", Time = 10})
OrionLib:Init()
